...
class BankAccountResourceIT {
    ...
    public static BankAccount createEntity(EntityManager em) {
        BankAccount bankAccount = new BankAccount().created(DEFAULT_CREATED).balance(DEFAULT_BALANCE).status(DEFAULT_STATUS);
        return bankAccount;
    }
    ...
    public static BankAccount createUpdatedEntity(EntityManager em) {
        BankAccount bankAccount = new BankAccount().created(UPDATED_CREATED).balance(UPDATED_BALANCE).status(UPDATED_STATUS);
        return bankAccount;
    }
    ...
    void createBankAccount() throws Exception {
        ...
        assertThat(testBankAccount.getCreated()).isEqualTo(DEFAULT_CREATED);
    ...
    void getAllBankAccounts() throws Exception {
        ...
        restBankAccountMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(bankAccount.getId().toString())))
    ...
    void getNonExistingBankAccount() throws Exception {
        // Get the bankAccount
        restBankAccountMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void putExistingBankAccount() throws Exception {
        ...
        updatedBankAccount.created(UPDATED_CREATED).balance(UPDATED_BALANCE).status(UPDATED_STATUS);
        ...
        BankAccount testBankAccount = bankAccountList.get(bankAccountList.size() - 1);
        assertThat(testBankAccount.getCreated()).isEqualTo(UPDATED_CREATED);
    ...
    void partialUpdateBankAccountWithPatch() throws Exception {
        ...
        partialUpdatedBankAccount.created(UPDATED_CREATED).balance(UPDATED_BALANCE);
    ...
    void fullUpdateBankAccountWithPatch() throws Exception {
        ...
        partialUpdatedBankAccount.created(UPDATED_CREATED).balance(UPDATED_BALANCE).status(UPDATED_STATUS);
    ...
    void deleteBankAccount() throws Exception {
        ...
        restBankAccountMockMvc
            .perform(delete(ENTITY_API_URL_ID, bankAccount.getId().toString()).accept(MediaType.APPLICATION_JSON))
